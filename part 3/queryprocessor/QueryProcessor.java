...
public class QueryProcessor {
	...
	public ArrayList<Pair<String, Double[]>> sortAndReturnPageRank() {
		...
		while(iterator.hasNext() && i<documents.size()){
			...
			statistics[5]= statistics[0]*100 + statistics[1]*10 + statistics[6]*200 + statistics[7]*10 + statistics[3]*50 + statistics[4] +Math.log(statistics[8])*200; // determining score
			Pair<String, Double[]> triple= Pair.createPair(s, statistics);
			arrayList.add(triple);
			i++;
		}
